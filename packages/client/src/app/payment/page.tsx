  ...
  return (
    <div>
        ...
        <div className="p-2">
          ...
          {/* TODO: Make this div go to the bottom */}
          <div>
            <p className="font-medium text-center">Please select a payment method:</p>
            <PaymentOptionCard onClick={() => alert('Direct debit')} title="Direct Debit" subtitle="Pay via Bank Transfer"/>
            <PaymentOptionCard onClick={() => alert('Pay now')} title="Pay Now" subtitle="Pay via a Debit or Credit Card"/>
          </div>
        </div>
    </div>
  )
