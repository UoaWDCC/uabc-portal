...
export default function SelectSessionPage() {
  return (
    <div className="h-[100dvh] flex flex-col">
      ...
      <div className="bg-[#EAEEF3] relative min-h-[66px] flex">
        <p className="p-5 text-md flex items-center">Hey David!</p>
      ...
      <div className="relative min-h-[76px] flex p-5">
        <p className="flex max-w-[55%] text-s leading-5 items-center">
      ...
      <div className="flex flex-col-reverse grow overflow-y-auto w-full gap-4 bg-bottom px-5">
        <DebitDetailsCard
          title="..."
          text={[
